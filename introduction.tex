...
\IEEEPARstart{C}onstrained devices are an essential part of Internet of Things (IoT) and therefore many proposals have been made for lightweight protocols which enables different connectivity models for constrained devices.  
CoAP

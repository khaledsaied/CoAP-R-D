...
The setup of the experiments is based on the IoTivity framework running on two Linux (Ubuntu) machines.  These two machines are both wireless coupled to a local network via a router. The test scenario is a client updating the temperature on a server with a specific interval of time. 
